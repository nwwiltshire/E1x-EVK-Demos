/*
 * hal.h — platform abstraction for the E1 acoustic-sentinel firmware.
 *
 ...
 *                 (DIGIO114).  (make e1)
 *
 * Everything above this line of the stack (main/pipeline/protocol) is
 ...
 * ever diffed across one chunk, so the wrap is harmless. */
